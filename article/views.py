...
def articleCreate(request):
    ...
    Create a new article instance
        ...
        3.Save the form to the mode and redirect the user to the article page
    :param request:
    :return:
    '''
...
def articleUpdate(request, articleId):
    ...
    Update the article instance:
        ...
        3.If the form is valid, save it to the model, otherwise rendr a bound form with error messages
    :param request:
    :param articleId:
    :return:
    '''
...
def commentDelete(request, commentId):
    '''
    Delete a comment:
      1.Get the comment to update and its articles; redirect to 404 if not found
